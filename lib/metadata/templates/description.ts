...
const DEFAULT_TEMPLATE = 'Gemefi is an EVM compatible Layer 1 to build for the future of Web3 ecosystem in the cryptocurrency realm, security and mass-adoption with Web3 industry.';
